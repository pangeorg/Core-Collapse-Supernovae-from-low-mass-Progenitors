...
\vertexprom  is a finite-volume hydrodynamics code with three-flavor, energy-dependent, ray-by-ray-plus (RbR+) neutrino transport including the full set of neutrino reactions and microphysics as detailed in \cite{Rampp2002}.  \NY{The numerical grid employed is the}{ We use an} axis-free YinYang-Grid \NY{developed by}{} \cite{Kageyama2004} \NY{and}{} implemented in \vertexprom by \cite{Melson2015}. It \NY{significantly reduces the artifacts of purely spherical grids on the polar axes}{ helps in relaxing the CFL time constraint caused by smaller cell size along the poles in a spherical polar grid}. 
...
As already stated by \cite{Janka2008}, the structure of the progenitor is the pivotal element enabling the fast and almost spherical expansion of the forward shock and early rise of explosion energies which are shown in \autoref{fig:e8pzkick}. 
...
As mentioned by \citet{Wongwathanarat2015} the evolution of the forward shock and neutrino-heated ejecta is very complex. De- and acceleration of the shock at the composition interfaces causes pressure inversions in the post-shock material that provide the ground for the growth of Rayleigh-Taylor instabilities, while the pile-up of matter behind the shock leads to the formation of a reverse shock. 
In the case of the ECSN like progenitor the formation of the reverse shock happens early, in the $z9.6$ model the forward shock has not even passed the He/H interface, and leads to early and dramatic deceleration of the metal rich ejecta. The $s9.0$ model however escapes the formation until the forward shock travels through the hydrogen envelope.
