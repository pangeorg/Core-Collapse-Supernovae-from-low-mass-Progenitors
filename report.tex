...
We define the locations of the composition interfaces, similar to 
...
The total masses of the different nuclei present in the pre-SN model
are listed in Table~\ref{tab:progenitor total masses}.
...
in this publication, has been used in various studies, including explosion properties \citep{Kitaura2006}, 
nucleosynthesis \citep{Janka2008,Wanajo2018}, effects of microphysics \citep{Huedepohl2010,Radice2017} and PNS kicks \citep{Gessner2018} and 
is a reference case for supernova simulations of ECSNe. 
The previously used 
